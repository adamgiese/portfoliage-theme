...
<?php // You can start editing here. ?>
  <?php if ( have_comments() ) : ?>
    <h3 id="comments-title" class="h2"><?php comments_number( __( '<span>No</span> Comments', 'skeletontheme' ), __( '<span>One</span> Comment', 'skeletontheme' ), __( '<span>%</span> Comments', 'skeletontheme' ) );?></h3>
